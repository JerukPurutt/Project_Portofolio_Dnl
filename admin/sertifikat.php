...
<head>
    ...
    <style>
        ...
        /* Tambahkan kelas ini untuk memaksa tinggi 100% viewport dan mencegah scroll global */
        .fixed-layout-body {
            height: 100vh; 
            overflow: hidden;
        }
                                ...
                                <tbody class="text-white text-sm font-light divide-y divide-gray-800">
                                    ...
                                    <tr class="hover:bg-gray-900 transition">
                                        ...
                                        <td class="py-4 px-6 font-medium text-lime-400">
                                            Juara 1 Lomba Web Development 2024
                                        </td>
                                        <td class="py-4 text-gray-400 max-w-xs truncate">
                                            Sertifikat ini diperoleh dari kompetisi tahunan yang diselenggarakan oleh Komunitas Developer Lokal. Membuktikan keahlian dalam Full-Stack Development.
                                        </td>
